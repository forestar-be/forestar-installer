...
import { useInstallationInfoSections } from '@/lib/hooks';
...
import { InstallationInfoSection, InstallationInfoItem } from '@/types';
...
export default function InstallationInfoManager() {
    ...
    <div className="mx-auto max-w-7xl px-4 py-4">
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600">
          Gérez les sections d&apos;information qui apparaîtront dans les PDF
          d&apos;installation.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        {sections.length === 0 && (
          <div className="py-12 text-center text-gray-500">
            Aucune section trouvée. Commencez par ajouter une nouvelle section.
          </div>
        )}
      </div>
